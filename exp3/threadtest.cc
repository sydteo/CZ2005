...
void TestValueOne()
{
	...
	Thread *inc1 = new Thread("Inc_1");
	inc1->Fork(Inc_v1,1,1);
	Thread *inc2 = new Thread("Inc_2");
	inc2->Fork(Inc_v1,2,1);
	Thread *dec1 = new Thread("Dec_1");
	dec1->Fork(Dec_v1,3,1);
	Thread *dec2 = new Thread("Dec_2");
...
//fill your code
Lock *lock = new Lock("Consistent_lock");
